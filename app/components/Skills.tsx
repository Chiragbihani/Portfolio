...
export default function Skills() {
  const skills = [
    ...
    },
    {
      ...
      technologies: "Node, Python, Java, C, C++",
    ...
    },
    {
      icon: Database,
      title: "Databases",
      technologies: "MongoDB, MySQL, MS-SQL",
    ...
    },
    {
      icon: Cloud,
      title: "Azure",
      technologies: "Azure Blob Storage, AFA, etc.",
      description: "Managing Azure based applications, workflows, and automation for business processes.",
      color: "indigo",
    },
    {
      icon: PencilRuler,
