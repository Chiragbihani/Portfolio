...
export default function About() {
  const skills = [
    ...
    },
    {
      ...
      title: "Backend",
      description: "Python, Node.js, Express.js",
    },
    {
    ...
    },
    {
      ...
      title: "Other",
      description: "MS Office, Cloud Computing",
    },
  ]
          ...
          >
            <div className="bg-slate-900/80 backdrop-blur-md p-8 rounded-2xl border border-indigo-500/20">
              <div className="flex items-center mb-6">
                ...
                <h3 className="text-2xl font-bold text-white font-display">Full-Stack Developer</h3>
              </div>

              <p className="text-xl text-slate-300 leading-relaxed mb-6">
                Specializing in Front-End and Project Management. Skilled in MERN, Python,
